/*
    CLOSURE: Es una función interna que tiene acceso a las variables de su
    función externa, incluso después de que la función externa haya terminado
    de ejecutarse. Esto significa que el closure tiene acceso al ámbito en
    el que fue creado y puede acceder a variables en ese ámbito, incluso si
    la función exterior ya no está activa.
*/
