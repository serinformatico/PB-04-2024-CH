...
async function demoUsuarios() {
    await usuarios.crearUsuario("Juan", "Perez", 24, "Programación Backend");
    await usuarios.crearUsuario("Lorena", "Medina", 18, "Programación Backend");
    await usuarios.crearUsuario("Maria", "Pereyra", 21, "Programación Frontend");
    await usuarios.consultarUsuarios();
}
