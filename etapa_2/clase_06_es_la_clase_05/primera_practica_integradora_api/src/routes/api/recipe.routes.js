...
router.put("/:rid/ingredients/:iid", checkAuth, async (req, res, next) => {
    try {
...
router.delete("/:rid/ingredients/:iid", checkAuth, async (req, res, next) => {
    try {
        const { rid, iid } = req.params;
...
router.delete("/:rid/ingredients", checkAuth, async (req, res, next) => {
    try {
